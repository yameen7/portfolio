            ...
            >
              <div className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  {certificate.link && <Button aria-label={certificate.title} variant="ghost" size="icon" className="opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
